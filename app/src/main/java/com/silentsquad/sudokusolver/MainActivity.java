...
import static com.silentsquad.sudokusolver.S5.SHARED_PREFS;
import static com.silentsquad.sudokusolver.S5.RESU;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resumeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(resume_button) {
                    Intent openResumegame = new Intent(getApplicationContext(), com.silentsquad.sudokusolver.S5.class);
        ...
        newgameBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openNewgame = new Intent(getApplicationContext(),com.silentsquad.sudokusolver.S3.class) ;
        ...
        instructionsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openInstructions = new Intent(getApplicationContext(),com.silentsquad.sudokusolver.Instructions.class) ;
        ...
        aboutUsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent OpenaboutUs = new Intent(getApplicationContext(),com.silentsquad.sudokusolver.AboutUs.class) ;
        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openSettings = new Intent(getApplicationContext(),com.silentsquad.sudokusolver.Settings.class) ;
